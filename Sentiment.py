...
# Tentukan direktori untuk menyimpan data NLTK di Streamlit
nltk_data_dir = '/home/appuser/nltk_data'
nltk.data.path.append(nltk_data_dir)

# Fungsi untuk mendownload sumber daya jika belum ada
...
# Download sumber daya yang diperlukan
...
def tokenize_text(kalimat):
    # Pastikan sumber daya NLTK telah terunduh sebelum tokenisasi
    try:
